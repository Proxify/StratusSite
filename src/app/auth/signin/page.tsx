    ...
    <div className="flex min-h-screen items-center justify-center bg-navy px-6">
      <div className="w-full max-w-md">
        <div className="mb-10 text-center">
          ...
          <p className="mt-3 text-muted">Sign in to access the platform</p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-navy-light p-8">
          ...
          <div className="space-y-4">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg border border-white/15 bg-white/5 px-6 py-3.5 text-sm font-medium text-white transition-colors hover:bg-white/10"
            >
